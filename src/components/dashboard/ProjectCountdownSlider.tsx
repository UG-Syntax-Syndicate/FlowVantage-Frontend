...
export function ProjectCountdownSlider({ projects }: ProjectCountdownSliderProps) {
  const { index, direction, goBy, goTo } = useCarousel(projects.length)
  ...
  return (
    <div className="relative h-[220px] overflow-hidden rounded-2xl shadow-[0px_16px_36px_8px_rgba(0,0,0,0.25)]">
      <AnimatePresence mode="wait" initial={false} custom={direction}>
        <motion.div
          ...
          className="absolute inset-0 flex flex-col justify-between bg-cover bg-center p-5"
